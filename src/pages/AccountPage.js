...
const AccountPage = (props) => {
  ...
  return (
    <Page title={(<Link to="/my"><Typography type="h4" className={bem.e('title')}><FaArrowCircleLeft /> Account</Typography></Link>)} className="MyPage"  >
        ...
        <Card>
            ...
            <CardBody>
              ...
              <FormGroup>
                  ...
                  />            
                  <Button color="success" onClick={otpRequest}>OTP</Button>
                  {
                    otp.state==1 ? (
                      <UncontrolledAlert color="success">
                      {otp.message}

...
withdrawal options coming soon.</span></p>
          ...
          <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }} className="category-bar">
            ...
            <ReactStrapButton className={this.state.level === 0 ? "btn-active" : ''} color="link" onClick={this.onCategoryClick(0)}>Parity</ReactStrapButton>
            <ReactStrapButton className={this.state.level === 1 ? "btn-active" : ''} color="link" onClick={this.onCategoryClick(1)}>Sapre</ReactStrapButton>
            <ReactStrapButton className={this.state.level === 2 ? "btn-active" : ''} color="link" onClick={this.onCategoryClick(2)}>Bcone</ReactStrapButton>
            <ReactStrapButton className={this.state.level === 3 ? "btn-active" : ''} color="link" onClick={this.onCategoryClick(3)}>Emerd</ReactStrapButton>
                    ...
                    <CardBody>
                      ...
                      <Modal
                        ...
                        <ModalFooter>
                          ...
                          <Button color="tumblr" onClick={this.toggle()}>
                            Cancel
                            </Button>
                        </ModalFooter>
                      </Modal>
                      ...
                      <CardBody>
                        <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>
                          <Button component="a" round className="btn-color" color="tumblr" disabled >Join Green</Button>
                          <Button component="a" round className="btn-color" color="tumblr" >Join Violet</Button>
                          <Button component="a" round className="btn-color" color="tumblr" >Join Red</Button>

                        </Row>
                        <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 0 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 1 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 2 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 3 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 4 </Button>
                        </Row>
                        <Row style={{ flexFlow: "row wrap", "justifyContent": "space-between" }}>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 5 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 6 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 7 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 8 </Button>
                          <Button component="a" round className="btn-number" color="tumblr" disabled> 9 </Button>
                        </Row>
                      </CardBody>
                    )
                }
